<?php get_header(); ?>
	...
	<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div <?php post_class(); ?>>
				<h2 id="post-<?php the_ID(); ?>"><small><?php the_time(get_option('date_format')) ?> <!-- by <?php the_author() ?> --></small><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permanent Link: %s', 'whiteasmilk' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h2>
